...
namespace Zynas.Framework.Core.Base.DataAccess
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    public abstract class BaseDataAccess<INPUT, OUTPUT>
    {
        #region メソッド(public)
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        public SqlConnection AddSqlConnection(SqlConnection connection)
        {
            return TransactionManager.AddSqlConnectionTran(connection);
        }
        #endregion

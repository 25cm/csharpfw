...
namespace FukjBizSystem.Application.BusinessLogic.Others.JokasoDaichoSyukeiList
{
    #region 入力インターフェイス定義
    ////////////////////////////////////////////////////////////////////////////
    //  インターフェイス名 ： IPrint11JoKensaMijukenBLInput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IPrint11JoKensaMijukenBLInput : IBaseExcelPrintBLInput
    {
        /// <summary>
    ...
    #region 入力クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： Print11JoKensaMijukenBLInput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class Print11JoKensaMijukenBLInput : BaseExcelPrintBLInputImpl, IPrint11JoKensaMijukenBLInput
    {
        /// <summary>
        /// JokasoDaichoSyukeiListDataTable
        /// </summary>
    ...
    #region 出力インターフェイス定義
    ////////////////////////////////////////////////////////////////////////////
    //  インターフェイス名 ： IPrint11JoKensaMijukenBLOutput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IPrint11JoKensaMijukenBLOutput : IBaseExcelPrintBLOutput
    {
    }
    #endregion
    ...
    #region 出力クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： Print11JoKensaMijukenBLOutput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class Print11JoKensaMijukenBLOutput : IPrint11JoKensaMijukenBLOutput
    {
        /// <summary>
        /// 保存パス
        /// </summary>
    ...
    #region クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： Print11JoKensaMijukenBusinessLogic
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class Print11JoKensaMijukenBusinessLogic : BaseExcelPrintBusinessLogic<IPrint11JoKensaMijukenBLInput, IPrint11JoKensaMijukenBLOutput>
    {
        #region プロパティ
        ...
        #region コンストラクタ
        ////////////////////////////////////////////////////////////////////////////
        //  コンストラクタ名 ： Print11JoKensaMijukenBusinessLogic
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        public Print11JoKensaMijukenBusinessLogic()
        {
        }
        #endregion
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        protected override IPrint11JoKensaMijukenBLOutput SetBook(IPrint11JoKensaMijukenBLInput input, Microsoft.Office.Interop.Excel.Workbook book)
        {
            IPrint11JoKensaMijukenBLOutput output = new Print11JoKensaMijukenBLOutput();
            ...
            try
            {
                ...
                for (int i = 0; i < syukeiListRows.Length; i++)
                {
                    ...
                    if (i == 0 || printRow.KensaIraiHokenjoCd != previousRow.KensaIraiHokenjoCd)
                    {
                        ...
                        {
                            //set print area
                            SetPrintArea(outputSheet, 0, 0, rowIdx - 1, 10);
                        }

                        //copy temp sheet
                        tempSheet.Copy(tempSheet, Type.Missing);
                        outputSheet = (Worksheet)book.ActiveSheet;
                        outputSheet.Name = string.Format("11条検査未受験一覧({0})", sheetIdx);

    ...
    class PrintKensaKekkaShoBusinessLogic : BaseExcelPrintBusinessLogic<IPrintKensaKekkaShoBLInput, IPrintKensaKekkaShoBLOutput>
    {
        ...
        protected override IPrintKensaKekkaShoBLOutput SetBook(IPrintKensaKekkaShoBLInput input, Microsoft.Office.Interop.Excel.Workbook book)
        {
            ...
            try
            {
                ...
                //get data
                ISelectKensaKekkaShoInfoByCondDAInput getKekkaShoInput = new SelectKensaKekkaShoInfoByCondDAInput();
                ...
                ISelectKensaKekkaShoInfoByCondDAOutput getKekkaShoOutput = new SelectKensaKekkaShoInfoByCondDataAccess().Execute(getKekkaShoInput);

                if (getKekkaShoOutput.KensaKekkaShoInfoDataTable == null) return output;

                for (int i = 0; i < getKekkaShoOutput.KensaKekkaShoInfoDataTable.Count; i++)
                {
                    outputSheet = tempSheet;
                    outputSheet.Name = "検査結果書_" + (i + 1);
                    KensaKekkaTblDataSet.KensaKekkaShoInfoRow printRow = getKekkaShoOutput.KensaKekkaShoInfoDataTable[i];
                    ...
                    if (getShokenKekkaDAOutput.ShokenKekkaListDataTable.Count > 0)
                    {
                        ...
                        //(40)
                        OutputShoken1(outputSheet, getShokenKekkaDAOutput.ShokenKekkaListDataTable, shokenContent);

                        //(41)
                        OutputShoken2(outputSheet, getShokenKekkaDAOutput.ShokenKekkaListDataTable, group);
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void OutputKensaKomokuKonkai(Worksheet outputSheet, KensaKekkaTblDataSet.KensaKekkaShoInfoRow printRow)
        {
            //水素イオン濃度 
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void OutputKensaKomokuZenkai(Worksheet outputSheet, KensaKekkaTblDataSet.KensaKekkaShoInfoRow kensaKekkaShoRow)
        {
            ISelectKensaKomokuInfoByKensaZenkaiDAInput daInput = new SelectKensaKomokuInfoByKensaZenkaiDAInput();
            ...
            ISelectKensaKomokuInfoByKensaZenkaiDAOutput daOutput = new SelectKensaKomokuInfoByKensaZenkaiDataAccess().Execute(daInput);

            if (daOutput.KensaKomokuInfoDataTable == null || daOutput.KensaKomokuInfoDataTable.Count == 0) return;

            int colIdx = 60;
            KensaKekkaTblDataSet.KensaKomokuInfoRow kensaKomokuRow = daOutput.KensaKomokuInfoDataTable[0];
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void OutputConstInfo(Worksheet outputSheet, ConstMstDataSet.ConstMstDataTable constDT, KensaKekkaTblDataSet.KensaKekkaShoInfoRow printRow)
        {
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void OutputSuishitsuInfo(Worksheet outputSheet, KensaKekkaTblDataSet.KensaKekkaShoInfoRow printRow, DateTime currentDateTime)
        {
            #region (1) ~ (28)
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void OutputShoken1(Worksheet outputSheet, ShokenKekkaTblDataSet.ShokenKekkaListDataTable shokenKekkaDT, StringBuilder shokenContent)
        {
            for (int j = 0; j < shokenKekkaDT.Count; j++)
            {
                ShokenKekkaTblDataSet.ShokenKekkaListRow currentShokenRow = shokenKekkaDT[j];
                ShokenKekkaTblDataSet.ShokenKekkaListRow previousShokenRow = shokenKekkaDT[(j > 0 ? j : 1) - 1];
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void OutputShoken2(Worksheet outputSheet, ShokenKekkaTblDataSet.ShokenKekkaListDataTable shokenKekkaDT, string group)
        {
            int colIdx = 40;
            ...
            for (int i = 0; i < shokenKekkaDT.Select("ShokenCheckHantei = '2' OR ShokenCheckHantei = '3'", "ShokenKbn").Length; i++)
            {
                ...
                ShokenKekkaTblDataSet.ShokenKekkaListRow currentShokenRow = shokenKekkaDT[i];
                ShokenKekkaTblDataSet.ShokenKekkaListRow previousShokenRow = shokenKekkaDT[(i > 0 ? i : 1) - 1];
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private void OutputShoken3(Worksheet outputSheet, KensaKekkaTblDataSet.KensaKekkaShoInfoRow kensaKekkaShoRow)
        {

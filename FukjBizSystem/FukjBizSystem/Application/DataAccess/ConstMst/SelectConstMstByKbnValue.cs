...
namespace FukjBizSystem.Application.DataAccess.ConstMst
{
    ...
    interface ISelectConstMstByKbnValueDAOutput
    {
        ...
        /// ConstMstDataTable
        /// </summary>
        ConstMstDataSet.ConstMstDataTable ConstMstDT { get; set; }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class SelectConstMstByKbnValueDataAccess : BaseDataAccess<ISelectConstMstByKbnValueDAInput, ISelectConstMstByKbnValueDAOutput>
    {
        ...
        public override ISelectConstMstByKbnValueDAOutput Execute(ISelectConstMstByKbnValueDAInput input)
        {
            ...
            try
            {
                ...
                output.ConstMstDT = tableAdapter.GetDataByKbnValue(input.ConstKbn, input.ConstValue);

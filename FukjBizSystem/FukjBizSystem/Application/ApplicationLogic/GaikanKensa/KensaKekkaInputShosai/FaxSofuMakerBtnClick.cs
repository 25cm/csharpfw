...
namespace FukjBizSystem.Application.ApplicationLogic.GaikanKensa.KensaKekkaInputShosai
{
    #region 入力インターフェイス定義
    ////////////////////////////////////////////////////////////////////////////
    //  インターフェイス名 ： IFaxSofuMakerBtnClickALInput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IFaxSofuMakerBtnClickALInput : IBseALInput
    {
        /// <summary>
        /// 検査依頼法定区分
        /// </summary>
    ...
    #region 入力クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： FaxSofuMakerBtnClickALInput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class FaxSofuMakerBtnClickALInput : IFaxSofuMakerBtnClickALInput
    {
        /// <summary>
        /// 検査依頼法定区分
        /// </summary>
    ...
    #region 出力インターフェイス定義
    ////////////////////////////////////////////////////////////////////////////
    //  インターフェイス名 ： IFaxSofuMakerBtnClickALOutput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IFaxSofuMakerBtnClickALOutput
    {
    ...
    #region 出力クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： FaxSofuMakerBtnClickALOutput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class FaxSofuMakerBtnClickALOutput : IFaxSofuMakerBtnClickALOutput
    {
    ...
    #region クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： FaxSofuMakerBtnClickApplicationLogic
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class FaxSofuMakerBtnClickApplicationLogic : BaseApplicationLogic<IFaxSofuMakerBtnClickALInput, IFaxSofuMakerBtnClickALOutput>
    {
        #region プロパティ
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KensaKekkaInputShosai：FaxSofuMakerBtnClick";

        #endregion

        #region コンストラクタ
        ////////////////////////////////////////////////////////////////////////////
        //  コンストラクタ名 ： FaxSofuMakerBtnClickApplicationLogic
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        public FaxSofuMakerBtnClickApplicationLogic()
        {
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        public override IFaxSofuMakerBtnClickALOutput Execute(IFaxSofuMakerBtnClickALInput input)
        {
            TraceLog.StartWrite(MethodInfo.GetCurrentMethod());

            // 出力クラスの実体作成
            IFaxSofuMakerBtnClickALOutput output = new FaxSofuMakerBtnClickALOutput();

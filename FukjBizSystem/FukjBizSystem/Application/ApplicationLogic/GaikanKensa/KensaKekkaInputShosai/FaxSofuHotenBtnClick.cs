...
namespace FukjBizSystem.Application.ApplicationLogic.GaikanKensa.KensaKekkaInputShosai
{
    #region 入力インターフェイス定義
    ////////////////////////////////////////////////////////////////////////////
    //  インターフェイス名 ： IFaxSofuHotenBtnClickALInput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IFaxSofuHotenBtnClickALInput : IBseALInput
    {
        /// <summary>
        /// 検査依頼法定区分
        /// </summary>
    ...
    #region 入力クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： FaxSofuHotenBtnClickALInput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class FaxSofuHotenBtnClickALInput : IFaxSofuHotenBtnClickALInput
    {
        /// <summary>
        /// 検査依頼法定区分
        /// </summary>
    ...
    #region 出力インターフェイス定義
    ////////////////////////////////////////////////////////////////////////////
    //  インターフェイス名 ： IFaxSofuHotenBtnClickALOutput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IFaxSofuHotenBtnClickALOutput
    {
    ...
    #region 出力クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： FaxSofuHotenBtnClickALOutput
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class FaxSofuHotenBtnClickALOutput : IFaxSofuHotenBtnClickALOutput
    {
    ...
    #region クラス定義
    ////////////////////////////////////////////////////////////////////////////
    //  クラス名 ： FaxSofuHotenBtnClickApplicationLogic
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class FaxSofuHotenBtnClickApplicationLogic : BaseApplicationLogic<IFaxSofuHotenBtnClickALInput, IFaxSofuHotenBtnClickALOutput>
    {
        #region プロパティ
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KensaKekkaInputShosai：FaxSofuHotenBtnClick";

        #endregion

        #region コンストラクタ
        ////////////////////////////////////////////////////////////////////////////
        //  コンストラクタ名 ： FaxSofuHotenBtnClickApplicationLogic
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        public FaxSofuHotenBtnClickApplicationLogic()
        {
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        public override IFaxSofuHotenBtnClickALOutput Execute(IFaxSofuHotenBtnClickALInput input)
        {
            TraceLog.StartWrite(MethodInfo.GetCurrentMethod());

            // 出力クラスの実体作成
            IFaxSofuHotenBtnClickALOutput output = new FaxSofuHotenBtnClickALOutput();

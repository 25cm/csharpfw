...
namespace FukjBizSystem.Application.ApplicationLogic.GaikanKensa.KensaNippoList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetKensaNippoListBySearchCondBLInput
    {
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("職員コード[{0}], 検査日検索使用フラグ[{1}], 検査日（開始）[{2}], 検査日（終了）[{3}], 対象区分[{4}]", 
                    new string[]{
                        ShokuinCd, 
                        KensaDtUse.ToString(),
                        KensaDtFrom,
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetKensaNippoListBySearchCondBLOutput
    {
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KensaNippoList：KensakuBtnClickApplicationLogic";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.KensaNippoListDT = new GetKensaNippoListBySearchCondBusinessLogic().Execute(input).KensaNippoListDT;
            }
            catch
            {
                throw;

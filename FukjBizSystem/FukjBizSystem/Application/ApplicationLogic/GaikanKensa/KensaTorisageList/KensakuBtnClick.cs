...
namespace FukjBizSystem.Application.ApplicationLogic.GaikanKensa.KensaTorisageList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetKensaTorisageListBySearchCondBLInput
    {
    }
    #endregion
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("協会No（開始）[{0}-{1}-{2}], 協会No（終了）[{3}-{4}-{5}]", 
                    new string[]{SearchCond.HokenjoCdFrom, SearchCond.NendoFrom, SearchCond.NendoFrom, SearchCond.HokenjoCdTo, 
                        SearchCond.NendoTo, SearchCond.RenbanTo});
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetKensaTorisageListBySearchCondBLOutput
    {
    }
    #endregion
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KensaTorisageList：KensakuBtnClick";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.KensaTorisageListDataTable = new GetKensaTorisageListBySearchCondBusinessLogic().Execute(input).KensaTorisageListDataTable;

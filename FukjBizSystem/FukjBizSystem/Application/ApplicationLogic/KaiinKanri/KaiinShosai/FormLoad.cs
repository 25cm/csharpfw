...
namespace FukjBizSystem.Application.ApplicationLogic.KaiinKanri.KaiinShosai
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IFormLoadALInput : IBseALInput, IGetGyoshaMstByKeyBLInput
    {
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IFormLoadALOutput : IGetGyoshaMstByKeyBLOutput, IGetGyoshaBukaiMstByGyoshaCdBLOutput
    {
    ...
    class FormLoadApplicationLogic : BaseApplicationLogic<IFormLoadALInput, IFormLoadALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KaiinShosai：FormLoadApplicationLogic";
        ...
        public override IFormLoadALOutput Execute(IFormLoadALInput input)
        {
            ...
            try
            {
                output.GyoshaMstDataTable = new GetGyoshaMstByKeyBusinessLogic().Execute(input).GyoshaMstDataTable;

                IGetGyoshaBukaiMstByGyoshaCdBLInput blInput = new GetGyoshaBukaiMstByGyoshaCdBLInput();
                blInput.GyoshaCd = input.GyoshaCd;
                output.GyoshaBukaiMstDataTable = new GetGyoshaBukaiMstByGyoshaCdBusinessLogic().Execute(blInput).GyoshaBukaiMstDataTable;
            }
            catch
            {
                throw;

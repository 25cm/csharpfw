...
namespace FukjBizSystem.Application.ApplicationLogic.KaiinKanri.KaiinNyukin
{
    ...
    class FormLoadApplicationLogic : BaseApplicationLogic<IFormLoadALInput, IFormLoadALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KaiinNyukin：FormLoad";
        ...
        public override IFormLoadALOutput Execute(IFormLoadALInput input)
        {
            ...
            try
            {
                ...
                output.NenKaihiTblDataTable = new GetNenKaihiTblInfoBusinessLogic().Execute(getNenKaihiBLInput).NenKaihiTblDataTable;

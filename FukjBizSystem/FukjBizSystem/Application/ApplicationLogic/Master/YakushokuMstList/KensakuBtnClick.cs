...
namespace FukjBizSystem.Application.ApplicationLogic.Master.YakushokuMstList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetYakushokuMstBySearchCondBLInput
    {
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("NameCd[{0}], 役職コード（開始）[{1}], 役職コード（終了）[{2}], 役職名[{3}]",
                    new string[]{
                        NameCd,
                        YakushokuCdFrom,
                        YakushokuCdTo,
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetYakushokuMstBySearchCondBLOutput
    {
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "YakushokuMstList：KensakuBtnClickApplicationLogic";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.YakushokuMstKensakuDT = new GetYakushokuMstBySearchCondBusinessLogic().Execute(input).YakushokuMstKensakuDT;
            }
            catch
            {
                throw;

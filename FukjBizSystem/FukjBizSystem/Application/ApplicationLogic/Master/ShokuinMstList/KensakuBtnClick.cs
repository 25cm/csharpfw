...
namespace FukjBizSystem.Application.ApplicationLogic.Master.ShokuinMstList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetShokuinMstBySearchCondBLInput
    {
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("ShishoCd[{0}], 職員コード（開始）[{1}], 職員コード（終了）[{2}], 職員名[{3}], 職員名カナ[{4}]",
                    new string[]{
                        ShishoCd,
                        ShokuinCdFrom,
                        ShokuinCdTo,
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetShokuinMstBySearchCondBLOutput
    {
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "ShoukuinMstList：KensakuBtnClickApplicationLogic";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.ShokuinMstKensakuDT = new GetShokuinMstBySearchCondBusinessLogic().Execute(input).ShokuinMstKensakuDT;
            }
            catch
            {
                throw;

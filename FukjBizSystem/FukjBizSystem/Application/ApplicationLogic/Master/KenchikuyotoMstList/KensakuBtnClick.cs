...
namespace FukjBizSystem.Application.ApplicationLogic.Master.KenchikuyotoMstList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetKenchikuyotoMstBySearchCondBLInput
    {
    }
    #endregion
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("建築用途大分類 [{0}]", KenchikuyotoDaibunrui);
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetKenchikuyotoMstBySearchCondBLOutput
    {
    }
    #endregion
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KenchikuyotoMstList：KensakuBtnClick";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.KenchikuyotoMstDataTable = new GetKenchikuyotoMstBySearchCondBusinessLogic().Execute(input).KenchikuyotoMstDataTable;

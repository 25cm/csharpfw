...
namespace FukjBizSystem.Application.ApplicationLogic.Master.GaikankensaKomokuMstList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetGaikankensaKomokuMstBySearchCondBLInput
    {
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("外観検査項目コード（開始）[{0}], 外観検査項目コード（終了）[{1}], 外観検査項目名称[{2}]",
                    new string []{
                        GaikankensaKomokuCdFrom,
                        GaikankensaKomokuCdTo,
                        GaikankensaKomokuNm
                    });
            }
        }
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetGaikankensaKomokuMstBySearchCondBLOutput
    {
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "GaikankensaKomokuMstList：KensakuBtnClickApplicationLogic";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.GaikankensaKomokuMstKensakuDT = new GetGaikankensaKomokuMstBySearchCondBusinessLogic().Execute(input).GaikankensaKomokuMstKensakuDT;
            }
            catch
            {
                throw;

...
namespace FukjBizSystem.Application.ApplicationLogic.Master.SaisuiinMstShosai
{
    ...
    interface IDecisionBtnClickALInput : IBseALInput, IUpdateSaisuiinMstBLInput
    {
        ...
        /// 表示モード
        /// </summary>
        SaisuiinMstShosaiForm.DispMode DispMode { get; set; }
    }
    #endregion
    ...
    class DecisionBtnClickALInput : IDecisionBtnClickALInput
    {
        ...
        /// 表示モード
        /// </summary>
        public SaisuiinMstShosaiForm.DispMode DispMode { get; set; }
    ...
    class DecisionBtnClickApplicationLogic : BaseApplicationLogic<IDecisionBtnClickALInput, IDecisionBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "SaisuiinMstShosai：DecisionBtnClick";
        ...
        public override IDecisionBtnClickALOutput Execute(IDecisionBtnClickALInput input)
        {
            ...
            try
            {
                ...
                // 登録
                if (input.DispMode == SaisuiinMstShosaiForm.DispMode.Add)
                {
                    if (string.IsNullOrEmpty(errMsg))
                    {
                        output.ErrMsg = string.Format("既に登録済みです。[採水員コード：{0}]", input.SaisuiinMstDataTable[0].SaisuiinCd);
                        return output;
                    }
        ...
        private void RakkanCheck(IDecisionBtnClickALInput input)
        {
            ...
            // 更新者
            input.SaisuiinMstDataTable[0].UpdateUser = Utility.ShokuinInfo.GetShokuinInfo().Shokuin.ShokuinNm;

            // 更新端末
            input.SaisuiinMstDataTable[0].UpdateTarm = Dns.GetHostName();
        }
        #endregion

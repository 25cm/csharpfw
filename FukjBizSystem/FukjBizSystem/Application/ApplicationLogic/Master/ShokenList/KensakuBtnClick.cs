...
namespace FukjBizSystem.Application.ApplicationLogic.Master.ShokenList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetShokenMstBySearchCondBLInput
    {
    }
    #endregion
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("所見区分[{0}], 所見コード（開始）[{1}], 所見コード（終了）[{2}]", ShokenKbn, ShokenCdFrom, ShokenCdTo);
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetShokenMstBySearchCondBLOutput
    {
    }
    #endregion
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "ShokenList：KensakuBtnClick";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.ShokenMstKensakuDataTable = new GetShokenMstBySearchCondBusinessLogic().Execute(input).ShokenMstKensakuDataTable;

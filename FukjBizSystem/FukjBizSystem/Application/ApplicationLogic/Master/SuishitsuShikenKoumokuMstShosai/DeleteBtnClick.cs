...
namespace FukjBizSystem.Application.ApplicationLogic.Master.SuishitsuShikenKoumokuMstShosai
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IDeleteBtnClickALInput : IBseALInput, IDeleteSuishitsuShikenKoumokuMstByKeyBLInput
    {
    }
    #endregion
    ...
    class DeleteBtnClickApplicationLogic : BaseApplicationLogic<IDeleteBtnClickALInput, IDeleteBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "SuishitsuShikenKoumokuMstShosai：DeleteBtnClick";
        ...
        public override IDeleteBtnClickALOutput Execute(IDeleteBtnClickALInput input)
        {
            ...
            try
            {
                ...
                if (!isExistKey(input.SuishitsuShikenKoumokuCd))
                {
                    output.ErrMessage = string.Format("該当するデータは登録されていません。[水質試験項目コード：{0}]", input.SuishitsuShikenKoumokuCd);
                    return output;
                }

                new DeleteSuishitsuShikenKoumokuMstByKeyBusinessLogic().Execute(input);
        ...
        /// </history>
        ////////////////////////////////////////////////////////////////////////////
        private bool isExistKey(string suishitsuShikenKoumokuCd)
        {

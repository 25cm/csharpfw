...
namespace FukjBizSystem.Application.ApplicationLogic.Keiri.KaikeiRendoList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetKaikeiRendoHdrTblBySearchCondBLInput
    {
    }
    #endregion
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("会計No（開始）[{0}], 会計No（終了）[{1}]", SearchCond.KaikeiNoFrom, SearchCond.KaikeiNoTo);
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetKaikeiRendoHdrTblBySearchCondBLOutput
    {
    }
    #endregion
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "KaikeiRendoList：KensakuBtnClick";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.KaikeiRendoHdrTblKensakuDataTable = new GetKaikeiRendoHdrTblBySearchCondBusinessLogic().Execute(input).KaikeiRendoHdrTblKensakuDataTable;

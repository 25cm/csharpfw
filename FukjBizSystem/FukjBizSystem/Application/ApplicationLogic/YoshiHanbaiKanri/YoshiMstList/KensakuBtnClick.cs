...
namespace FukjBizSystem.Application.ApplicationLogic.YoshiHanbaiKanri.YoshiMstList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetYoshiMstBySearchCondBLInput
    {
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("用紙コード（開始）[{0}], 用紙コード（終了）[{1}], 名称[{2}]",
                    new string[]{
                        YoshiCdFrom, YoshiCdTo, YoshiNm
                    });
            }
        }
    }
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetYoshiMstBySearchCondBLOutput
    {
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "YoshiMstList：KensakuBtnClickApplicationLogic";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.YoshiMstKensakuDT = new GetYoshiMstBySearchCondBusinessLogic().Execute(input).YoshiMstKensakuDT;
            }
            catch
            {
                throw;

...
using FukjBizSystem.Application.DataSet.JokasoDaichoKanri.JokasoDaichoKanriDataSetTableAdapters;
...
namespace FukjBizSystem.Application.ApplicationLogic.JokasoDaichoKanri.JokasoDaichoShosai
{
    ...
    interface IFormLoadALOutput
    {
        ...
        /// 
        /// </summary>
        JokasoDaichoKanriDataSet.JokasoKensaRirekiDataTable RirekiDataTable { get; set; }
    }
    #endregion
    ...
    class FormLoadALOutput : IFormLoadALOutput
    {
        ...
        /// 
        /// </summary>
        public JokasoDaichoKanriDataSet.JokasoKensaRirekiDataTable RirekiDataTable { get; set; }
    }
    #endregion
    ...
    class FormLoadApplicationLogic : BaseApplicationLogic<IFormLoadALInput, IFormLoadALOutput>
    {
        ...
        public override IFormLoadALOutput Execute(IFormLoadALInput input)
        {
            ...
            try
            {
                ...
                #region get optional data

                {
                    JokasoDaichoKanriDataSet.JokasoKensaRirekiDataTable templateTable = new JokasoDaichoKanriDataSet.JokasoKensaRirekiDataTable();

                    IStdFilteredGetDataBLInput blInput = new StdFilteredGetDataBLInput();
                    blInput.DataTableType = typeof(JokasoDaichoKanriDataSet.JokasoKensaRirekiDataTable);
                    blInput.TableAdapterType = typeof(JokasoKensaRirekiTableAdapter);
                    blInput.Query.AddEqualCond(templateTable.KensaJokasoHokenjoCdColumn.ColumnName, input.HokenjoCd);
                    blInput.Query.AddEqualCond(templateTable.KensaJokasoNendoColumn.ColumnName, input.TorokuNendo);
                    blInput.Query.AddEqualCond(templateTable.KensaJokasoRenbanColumn.ColumnName, input.Renban);

                    blInput.Query.AddOrderCol(templateTable.KensaDateColumn.ColumnName, false);
                    blInput.Query.AddOrderCol(templateTable.IraiNendoColumn.ColumnName, false);
                    blInput.Query.AddOrderCol(templateTable.IraiCdColumn.ColumnName, true);
                    blInput.Query.AddOrderCol(templateTable.IraiRenbanColumn.ColumnName, false);

                    IStdFilteredGetDataBLOutput blOutput = new StdFilteredGetDataBusinessLogic().Execute(blInput);

                    output.RirekiDataTable = (JokasoDaichoKanriDataSet.JokasoKensaRirekiDataTable)blOutput.GetDataTable;
                }

...
namespace FukjBizSystem.Application.ApplicationLogic.KensaKekka.KensaKekkaList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetKensaKekkaListBySearchCondBLInput
    {
    }
    #endregion
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("検査番号（開始） (保健所コード)[{0}], 検査番号（開始） (年度)[{1}], 検査番号（開始） (連番)[{2}], 検査番号（終了） (保健所コード)[{3}], 検査番号（終了） (年度)[{4}], 検査番号（終了） (連番)[{5}]",
                    new string[] {SearchCond.HokenjoCdFrom, SearchCond.NendoFrom, SearchCond.RenbanFrom, SearchCond.HokenjoCdTo, SearchCond.NendoTo, SearchCond.RenbanTo});
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetKensaKekkaListBySearchCondBLOutput
    {
    }
    #endregion

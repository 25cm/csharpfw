...
namespace FukjBizSystem.Application.ApplicationLogic.SuishitsuKensaKanri.YachoOutput
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface ISearchBtnClickALInput : IBseALInput, IGetYachoOutputKensaListBySearchCondBLInput
    {
    ...
    class SearchBtnClickALInput : ISearchBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("依頼年度[{0}], 支所[{1}], 水質検査依頼番号（開始）[{2}], 水質検査依頼番号（終了）[{3}]",
                    SearchCond.IraiNendo, SearchCond.ShishoCd, SearchCond.IraiNoFrom, SearchCond.IraiNoTo);
            }
        }

        #region コンストラクタ
        /// <summary>
        /// SearchBtnClickALInput
        /// </summary>
        public SearchBtnClickALInput()
        {
            SearchCond = new YachoOutputSearchCond();
        }
        #endregion
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface ISearchBtnClickALOutput : IGetYachoOutputKensaListBySearchCondBLOutput
    {
    ...
    class SearchBtnClickApplicationLogic : BaseApplicationLogic<ISearchBtnClickALInput, ISearchBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "YachoOutput：SearchBtnClick";
        ...
        public override ISearchBtnClickALOutput Execute(ISearchBtnClickALInput input)
        {
            ...
            try
            {
                IGetYachoOutputKensaListBySearchCondBLOutput blOutput = new GetYachoOutputKensaListBySearchCondBusinessLogic().Execute(input);
                output.YachoOutputKensaListDataTable = blOutput.YachoOutputKensaListDataTable;
            }
            catch
            {
                throw;

...
namespace FukjBizSystem.Application.ApplicationLogic.SuishitsuKensaKanri.KensaKekkaInput
{
    ...
    class FormLoadALOutput : IFormLoadALOutput
    {
        ...
        /// 法定検査用水質試験項目マスタ
        /// </summary>
        //public SuishitsuShikenKoumokuMstDataSet.SuishitsuShikenKoumokuMstDataTable HoteiSuishitsuShikenKoumokuMstDataTable { get; set; }
        ...
        /// 計量証明用水質試験項目マスタ
        /// </summary>
        //public SuishitsuShikenKoumokuMstDataSet.SuishitsuShikenKoumokuMstDataTable KeiryoSuishitsuShikenKoumokuMstDataTable { get; set; }
    ...
    class FormLoadApplicationLogic : BaseApplicationLogic<IFormLoadALInput, IFormLoadALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "検査結果入力：FormLoad";
        ...
        public override IFormLoadALOutput Execute(IFormLoadALInput input)
        {
            ...
            try
            {
                ...
                // 20150107 sou Start
                //IGetSuishitsuKekkaNmMstBySuishitsuKekkaShishoCdBLInput sknmInput = new GetSuishitsuKekkaNmMstBySuishitsuKekkaShishoCdBLInput();
                //sknmInput.SuishitsuKekkaShishoCd = Utility.ShokuinInfo.GetShokuinInfo().Shokuin.ShokuinShozokuShishoCd;
                //IGetSuishitsuKekkaNmMstBySuishitsuKekkaShishoCdBLOutput sknmOutput = new GetSuishitsuKekkaNmMstBySuishitsuKekkaShishoCdBusinessLogic().Execute(sknmInput);
                //output.SuishitsuKekkaNmMstDataTable = sknmOutput.SuishitsuKekkaNmMstDataTable;
                IGetSuishitsuKekkaNmMstBySearchCondFromToBLInput sknmInput = new GetSuishitsuKekkaNmMstBySearchCondFromToBLInput();
                sknmInput.ShishoCd = Utility.ShokuinInfo.GetShokuinInfo().Shokuin.ShokuinShozokuShishoCd;
                sknmInput.ShishoCd = (sknmInput.ShishoCd == "0" ? "3" : sknmInput.ShishoCd); // 事務局→福岡
                sknmInput.SuishitsuKekkaNmCdFrom = string.Empty;
                sknmInput.SuishitsuKekkaNmCdTo = string.Empty;
                IGetSuishitsuKekkaNmMstBySearchCondFromToBLOutput sknmOutput = new GetSuishitsuKekkaNmMstBySearchCondFromToBusinessLogic().Execute(sknmInput);
                output.SuishitsuKekkaNmMstDataTable = sknmOutput.SuishitsuKekkaNmMstDT;
                // 20150107 sou End
                ...
                //output.HoteiSuishitsuShikenKoumokuMstDataTable = (new SelectSuishitsuShikenKoumokuMstByConstKbnDataAccess().Execute(hoteiIn)).SuishitsuShikenKoumokuMstDataTable;
                ...
                //output.KeiryoSuishitsuShikenKoumokuMstDataTable = (new SelectSuishitsuShikenKoumokuMstByConstKbnDataAccess().Execute(keiryoIn)).SuishitsuShikenKoumokuMstDataTable;

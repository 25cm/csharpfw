...
namespace FukjBizSystem.Application.ApplicationLogic.Others.TuckSealList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface ISearchBtnClickALInput : IBseALInput, IGetTuckSealListBySearchCondBLInput
    {
    ...
    class SearchBtnClickALInput : ISearchBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("発行区分[{0}], 名[{1}], 登録年月[{2}], 保健所コード[{3}], コード（開始）[{4}], コード（終了）[{5}]",
                    SearchCond.RdSelect, SearchCond.SearchNm, SearchCond.Nengetsu, SearchCond.HokenjoCd, SearchCond.CdFrom, SearchCond.CdTo);
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface ISearchBtnClickALOutput : IGetTuckSealListBySearchCondBLOutput
    {
    ...
    class SearchBtnClickApplicationLogic : BaseApplicationLogic<ISearchBtnClickALInput, ISearchBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "TuckSeal：SearchBtnClick";
        ...
        public override ISearchBtnClickALOutput Execute(ISearchBtnClickALInput input)
        {
            ...
            try
            {
                IGetTuckSealListBySearchCondBLOutput blOutput = new GetTuckSealListBySearchCondBusinessLogic().Execute(input);
                output.TuckSealListDataTable = blOutput.TuckSealListDataTable;
            }
            catch
            {
                throw;

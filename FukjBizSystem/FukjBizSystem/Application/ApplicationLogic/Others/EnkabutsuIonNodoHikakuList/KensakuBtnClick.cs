...
using FukjBizSystem.Application.BusinessLogic.Others.EnkabutsuIonNodoHikakuList;
using FukjBizSystem.Application.DataSet;
using Zynas.Framework.Core.Base.ApplicationLogic;
using Zynas.Framework.Utility;

namespace FukjBizSystem.Application.ApplicationLogic.Others.EnkabutsuIonNodoHikakuList
{
    #region 入力インターフェイス定義
    ////////////////////////////////////////////////////////////////////////////
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetEnkabutsuIonNodoHikakuListBySearchCondBLInput
    {
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("採水日（開始）[{0}], 採水日（終了）[{1}], 採水員名[{2}]",
                    new string[] { SaisuiDtFrom, SaisuiDtTo, SaisuiinNm });
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetEnkabutsuIonNodoHikakuListBySearchCondBLOutput
    {
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "EnkabutsuIonNodoHikakuList：KensakuBtnClickApplicationLogic";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.EnkabutsuIonNodoHikakuListDT = new GetEnkabutsuIonNodoHikakuListBySearchCondBusinessLogic().Execute(input).EnkabutsuIonNodoHikakuListDT;
            }
            catch
            {
                throw;

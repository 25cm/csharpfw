...
namespace FukjBizSystem.Application.ApplicationLogic.KensaIraiKanri.KensaKeikaku
{
    ...
    interface IDecisionBtnClickALInput : IBseALInput
    {
        ...
        /// 
        /// </summary>
        JokasoDaichoMstDataSet.JokasoDaichoMstDataTable JokasoDaichoMstUpdateData { get; set; }
    }
    #endregion
    ...
    class DecisionBtnClickALInput : IBseALInputImpl, IDecisionBtnClickALInput
    {
        ...
        /// 
        /// </summary>
        public JokasoDaichoMstDataSet.JokasoDaichoMstDataTable JokasoDaichoMstUpdateData { get; set; }
    }
    #endregion
        ...
        public override IDecisionBtnClickALOutput Execute(IDecisionBtnClickALInput input)
        {
            ...
            try
            {
...

                {
                    ...
                    IStdUpdateDataBLInput blInput = new StdUpdateDataBLInput();
                    blInput.KeyColNameList.Add(templateTable.JokasoHokenjoCdColumn.ColumnName);
                    blInput.KeyColNameList.Add(templateTable.JokasoTorokuNendoColumn.ColumnName);
                    blInput.KeyColNameList.Add(templateTable.JokasoRenbanColumn.ColumnName);
                    blInput.TableName = templateTable.TableName;
                    blInput.TargetDataTable = input.JokasoDaichoMstUpdateData;

                    // 更新対象カラムを指定する
                    blInput.AddTargetColumn(templateTable.JokasoHokenjoCdColumn.ColumnName);
                    blInput.AddTargetColumn(templateTable.JokasoTorokuNendoColumn.ColumnName);
                    blInput.AddTargetColumn(templateTable.JokasoRenbanColumn.ColumnName);

                    blInput.AddTargetColumn(templateTable.JokasoSetchiBashoAdrColumn.ColumnName);

                    blInput.AddTargetColumn(templateTable.JokasoZenrinIdoCdColumn.ColumnName);
                    blInput.AddTargetColumn(templateTable.JokasoZenrinKeidoCdColumn.ColumnName);

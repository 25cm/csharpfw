...
namespace FukjBizSystem.Application.ApplicationLogic.UketsukeKanri.Jo7KensaIraiList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGet7JoKensaIraiListBySearchCondBLInput
    {
    }
    #endregion
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("依頼受付日（開始）[{0}], 依頼受付日（終了）[{1}], 送付日の追加フラグ[{2}]", KensaIraiDtFrom, KensaIraiDtTo, IsCheckKensaIraiSofuDt);
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGet7JoKensaIraiListBySearchCondBLOutput
    {
    }
    #endregion
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "Jo7KensaIraiList：KensakuBtnClick";

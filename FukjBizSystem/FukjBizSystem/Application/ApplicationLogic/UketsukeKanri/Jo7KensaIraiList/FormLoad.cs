...
namespace FukjBizSystem.Application.ApplicationLogic.UketsukeKanri.Jo7KensaIraiList
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IFormLoadALInput : IBseALInput, IGet7JoKensaIraiListBySearchCondBLInput
    {
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IFormLoadALOutput : IGet7JoKensaIraiListBySearchCondBLOutput
    {
    }
    #endregion
    ...
    class FormLoadApplicationLogic : BaseApplicationLogic<IFormLoadALInput, IFormLoadALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "Jo7KensaIraiList：FormLoad";
        ...
        public override IFormLoadALOutput Execute(IFormLoadALInput input)
        {
            ...
            try
            {
                output.Jo7KensaIraiListDataTable = new Get7JoKensaIraiListBySearchCondBusinessLogic().Execute(input).Jo7KensaIraiListDataTable;

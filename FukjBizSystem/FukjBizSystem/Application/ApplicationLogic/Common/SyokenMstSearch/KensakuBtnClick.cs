...
namespace FukjBizSystem.Application.ApplicationLogic.Common.SyokenMstSearch
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetSyokenMstSearchBySearchCondBLInput
    {
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("指摘区分[{0}], 所見区分[{1}], 所見文章[{2}]", new string[] { ShokenShitekiKbn, ShokenKbn, ShokenWd });
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetSyokenMstSearchBySearchCondBLOutput
    {
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "SyokenMstSearch：KensakuBtnClickApplicationLogic";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.SyokenMstSearchListDT = new GetSyokenMstSearchBySearchCondBusinessLogic().Execute(input).SyokenMstSearchListDT;
            }
            catch
            {
                throw;

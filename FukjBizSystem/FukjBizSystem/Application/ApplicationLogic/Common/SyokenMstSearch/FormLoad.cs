...
namespace FukjBizSystem.Application.ApplicationLogic.Common.SyokenMstSearch
{
    ...
    class FormLoadApplicationLogic : BaseApplicationLogic<IFormLoadALInput, IFormLoadALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "SyokenMstSearch：FormLoadApplicationLogic";
        ...
        public override IFormLoadALOutput Execute(IFormLoadALInput input)
        {
            ...
            try
            {
                ...
                IGetSyokenMstSearchBySearchCondBLInput blInput = new GetSyokenMstSearchBySearchCondBLInput();
                output.SyokenMstSearchListDT = new GetSyokenMstSearchBySearchCondBusinessLogic().Execute(blInput).SyokenMstSearchListDT;
                //ADD_20141106_HuyTX End
            }
            catch
            {
                throw;

...
namespace FukjBizSystem.Application.ApplicationLogic.Common.YubinJusyoMstSearch
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALInput : IBseALInput, IGetYubinNoAdrMstBySearchCondBLInput
    {
    }
    #endregion
    ...
    class KensakuBtnClickALInput : IKensakuBtnClickALInput
    {
        ...
        public string DataString
        {
            get
            {
                return string.Format("郵便番号[{0}], 住所[{1}]", ZipCd, Address);
            }
        }
    }
    #endregion
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKensakuBtnClickALOutput : IGetYubinNoAdrMstBySearchCondBLOutput
    {
    }
    #endregion
    ...
    class KensakuBtnClickApplicationLogic : BaseApplicationLogic<IKensakuBtnClickALInput, IKensakuBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "YubinJusyoMstSearch：KensakuBtnClick";
        ...
        public override IKensakuBtnClickALOutput Execute(IKensakuBtnClickALInput input)
        {
            ...
            try
            {
                output.YubinNoAdrMstDT = new GetYubinNoAdrMstBySearchCondBusinessLogic().Execute(input).YubinNoAdrMstDT;
            }
            catch
            {
                throw;

...
namespace FukjTabletSystem.Application.ApplicationLogic.Kensa.KihonJouhouTabPage
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKakuteiBtnClickALInput : IBseALInput, IUpdateJokasoDaichoMstWithoutLocationBLInput, IUpdateKensaIraiForKihonJouhouUpdateBLInput
    {
    }
    #endregion
        ...
        public override IKakuteiBtnClickALOutput Execute(IKakuteiBtnClickALInput input)
        {
            ...
            try
            {
                try
                {
                    ...
                    // 更新実行
                    IUpdateJokasoDaichoMstWithoutLocationBLOutput blOutput = new UpdateJokasoDaichoMstWithoutLocationBusinessLogic().Execute(input);

                    // 更新実行
                    IUpdateKensaIraiForKihonJouhouUpdateBLOutput iraiOutput = new UpdateKensaIraiForKihonJouhouUpdateBusinessLogic().Execute(input);

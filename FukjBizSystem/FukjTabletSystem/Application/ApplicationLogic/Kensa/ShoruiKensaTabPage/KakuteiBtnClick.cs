...
using FukjTabletSystem.Application.BusinessLogic.Kensa.ShoruiKensaTabPage;
...
namespace FukjTabletSystem.Application.ApplicationLogic.Kensa.ShoruiKensaTabPage
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    interface IKakuteiBtnClickALInput : IBseALInput, IUpdateShokenKekkaTblBLInput, IUpdateShokenKekkaHosokuTblBLInput, IUpdateKensaKekkaForShoruiUpdateBLInput
    {
    }
    #endregion
    ...
    class KakuteiBtnClickApplicationLogic : BaseApplicationLogic<IKakuteiBtnClickALInput, IKakuteiBtnClickALOutput>
    {
        ...
        /// 機能名
        /// </summary>
        private const string FunctionName = "ShoruiKensaTabPage：KakuteiBtnClick";
        ...
        public override IKakuteiBtnClickALOutput Execute(IKakuteiBtnClickALInput input)
        {
            ...
            try
            {
                try
                {
                    ...
                    if (input.KensaKekkaForShoruiUpdate.Count > 0)
                    {
                        new UpdateKensaKekkaForShoruiUpdateBusinessLogic().Execute(input);
                    }

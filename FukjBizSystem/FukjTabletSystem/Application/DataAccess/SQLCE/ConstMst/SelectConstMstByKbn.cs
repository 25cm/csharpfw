...
namespace FukjTabletSystem.Application.DataAccess.SQLCE.ConstMst
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class SelectConstMstByKbnDataAccess : BaseDataAccessCe<ISelectConstMstByKbnDAInput, ISelectConstMstByKbnDAOutput>
    {
        ...
        public override ISelectConstMstByKbnDAOutput Execute(ISelectConstMstByKbnDAInput input)
        {
            ...
            try
            {
                ...
                output.ConstMst = tableAdapter.GetDataByKbn(input.ConstKbn);

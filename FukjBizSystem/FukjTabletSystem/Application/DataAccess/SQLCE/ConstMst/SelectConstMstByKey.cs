...
namespace FukjTabletSystem.Application.DataAccess.SQLCE.ConstMst
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class SelectConstMstByKeyDataAccess : BaseDataAccessCe<ISelectConstMstByKeyDAInput, ISelectConstMstByKeyDAOutput>
    {
        ...
        public override ISelectConstMstByKeyDAOutput Execute(ISelectConstMstByKeyDAInput input)
        {
            ...
            try
            {
                ...
                output.ConstMst = tableAdapter.GetDataByKey(input.ConstKbn, input.ConstRenban);

...
namespace FukjTabletSystem.Application.DataAccess.SQLCE.ShokenMst
{
    ...
    /// </history>
    ////////////////////////////////////////////////////////////////////////////
    class SelectShokenMstByKeyDataAccess : BaseDataAccessCe<ISelectShokenMstByKeyDAInput, ISelectShokenMstByKeyDAOutput>
    {
        ...
        public override ISelectShokenMstByKeyDAOutput Execute(ISelectShokenMstByKeyDAInput input)
        {
            ...
            try
            {
                ...
                output.ShokenMst = tableAdapter.GetDataByKey(input.ShokenKbn, input.ShokenCd);
